# Assuming the extract_journal_info function is in the journal_info_extractor.py file
...
def add_paper_to_graph_from_json(graph, data):
    ...
    for name in author_names:
        author_uri = EX[f'Author/{name.replace(" ", "_").lower()}']
    ...
    for category in data['categories']:
        area_uri = EX[f'Area/{category.replace(".", "_")}']
    ...
    if data['journal-ref']:
        ...
        journal_uri = EX[f'Journal/{journal_title.replace(" ", "_")}']
        print(journal_title)
